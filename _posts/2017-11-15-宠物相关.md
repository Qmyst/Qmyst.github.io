 ...
 <body link="blue" vlink="purple" class="xl65">
  <table width="996" border="0" cellpadding="0" cellspacing="0" style='width:border-collapse:collapse;table-layout:fixed;'>
   <tr height="19" style='height:14.25px;'>
    ...
    <td class="xl65" width="88" style='width:66.00px;' x:str>名字</td>
    <td class="xl66" width="144" style='width:108.00px;' x:str>属性加成</td>
    <td class="xl65" width="310" style='width:232.50px;' x:str>特效效果</td>
    <td class="xl65" width="161" style='width:120.75px;' x:str>掉落关卡</td>
